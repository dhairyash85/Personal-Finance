        ...
        <div
            ...
            <div className="relative flex flex-col items-center text-center lg:text-left lg:py-7 xl:py-8 
                ...
                font-bold text-white">
                    Keep track of your <span
                        className="text-gradient">Personal Finance {" "} </span><br></br>
                    with us.
                </h1>
                <p className="mt-8 text-white">
                    Track your expenses cwith us
                </p>
                    ...
                    <div className="flex sm:flex-row flex-col gap-5 w-full">
                        {
                            user.length==0?(
                                ...
                                <button className="flex text-white justify-center items-center w-max min-w-max sm:w-max px-6 h-12 rounded-full outline-none relative overflow-hidden border duration-300 ease-linear
                                after:absolute after:inset-x-0 after:aspect-square after:scale-0 after:opacity-70 after:origin-center after:duration-300 after:ease-linear after:rounded-full after:top-0 after:left-0 after:bg-[#21492e] hover:after:opacity-100 hover:after:scale-[2.5] bg-green-400 border-transparent hover:border-[#21492e]" onClick={handleClick}>
                                <span className="hidden sm:flex relative ">
                                    Add Expenses
                                </span>
                                <span className="flex sm:hidden relative ">
