      ...
      <div className="max-w-md w-full space-y-8 p-10 bg-white rounded-xl z-10 h-max">
        ...
        <form className="mt-8 space-y-6" action="#" method="POST">
          ...
          <div className="mt-8 content-center">
            ...
            <input
              className="w-full content-center text-base py-2 border-b border-gray-300 focus:outline-none focus:border-green-400"
              type="password"
              name="password"
          ...
          <div className="flex items-center justify-between">
            <div className="text-sm">
              <a
                href="#"
                className="font-medium text-green-400 hover:text-green-400"
              >
